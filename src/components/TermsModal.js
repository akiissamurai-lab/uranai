...
const TERMS_SECTIONS = [
  {
    title: null,
    body: `この利用規約（以下、「本規約」といいます）は、アキ（以下、「当社」といいます）が提供するサービス「マクロ飯ビルダー」（以下、「本サービス」といいます）の利用条件を定めるものです。ユーザーの皆様（以下、「ユーザー」といいます）には、本規約に従って本サービスをご利用いただきます。\n\n※本サービスをご利用になる前に、以下の「第2条（健康に関する免責事項）」を必ずお読みいただき、同意の上でご利用ください。`,
  },
  {
...
const PRIVACY_SECTIONS = [
  {
    title: null,
    body: `アキ（以下、「当社」といいます）は、当社が提供するサービス「マクロ飯ビルダー」（以下、「本サービス」といいます）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます）を定めます。`,
  },
  {
    title: "第1条（収集する情報）",
